...
from imp_sec_cam_nor.data_info.variable_info import import_constants as import_constants_list
from imp_sec_cam_nor.util.filenames import get_filename_constants
from imp_sec_cam_nor import constants
from imp_sec_cam_nor.util.imports.fix_xa_dataset_v2 import xr_fix
from imp_sec_cam_nor.constants import latlon_path
...
def xr_import_NorESM(case, varlist, from_time, to_time, path=constants.get_input_datapath(),
    ...
    if varlist is not None:
        ...
        drop_list = list((set(dummy.data_vars.keys()) - set(var_names_mod)) - set(
            imp_sec_cam_nor.data_info.variable_info.import_always_include))
        dummy.close()
    else:
        drop_list = None
    # Read the files:
