...
import numpy as np
import xarray as xr
from imp_sec_cam_nor.util.slice_average import area_mod
...
def xr_fix(dtset, model_name='NorESM', comp='atm'):
    ...
    if model_name == 'NorESM':
        ...
        NCONC_noresm = imp_sec_cam_nor.data_info.variable_info.sized_varListNorESM['NCONC']
        ...
        NMR_noresm = imp_sec_cam_nor.data_info.variable_info.sized_varListNorESM['NMR']
...
def _ch_unit(dtset, typ, var):
    fac = imp_sec_cam_nor.data_info.variable_info.default_units[typ]['factor']
    un = imp_sec_cam_nor.data_info.variable_info.default_units[typ]['units']
    exceptions = imp_sec_cam_nor.data_info.variable_info.default_units[typ]['exceptions']
