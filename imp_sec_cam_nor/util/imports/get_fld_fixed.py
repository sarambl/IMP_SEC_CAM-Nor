...
from imp_sec_cam_nor.util.filenames import get_filename_ng_field
...
from imp_sec_cam_nor.util.imports.import_fields_xr_v2 import xr_import_NorESM, import_constants
