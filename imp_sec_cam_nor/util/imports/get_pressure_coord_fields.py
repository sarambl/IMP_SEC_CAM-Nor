...
import os.path
from imp_sec_cam_nor.util.imports.hybridsig2pressure import hybsig2pres_vars
...
def get_pressure_coord_fields(case, varlist, from_time, to_time, history_field,
    ...
    :return:
    """
    varlist_get = list(set(varlist).union(set(imp_sec_cam_nor.data_info.variable_info.import_always_include)))
