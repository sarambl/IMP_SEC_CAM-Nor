...
from imp_sec_cam_nor.util.Nd.sizedist_class_v2.SizedistributionSurface import SizedistributionSurface
from imp_sec_cam_nor.util.collocate.collocate import CollocateModel
from imp_sec_cam_nor.util.filenames import get_filename_pressure_coordinate_field, get_filename_ng_field

from imp_sec_cam_nor.data_info.variable_info import sized_varListNorESM
from imp_sec_cam_nor.util.imports.get_pressure_coord_fields import get_pressure_coord_fields
from imp_sec_cam_nor.util.Nd.sizedist_class_v2 import Sizedistribution
from imp_sec_cam_nor import constants
import imp_sec_cam_nor.util.Nd.sizedist_class_v2.constants as constants_sizedist
import imp_sec_cam_nor.util.Nd.sizedist_class_v2.constants as constants_sizedist
from imp_sec_cam_nor.util.practical_functions import make_folders
from imp_sec_cam_nor.util.naming_conventions.var_info import get_varname_Nd
import numpy as np
...
class SizedistributionStationBins(SizedistributionSurfaceBins):
    ...
    def __init__(self,*vars, diameters = constants_sizedist.diameters_observation, **kwargs):
        self.diameters= diameters
