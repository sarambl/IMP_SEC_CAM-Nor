...
import imp_sec_cam_nor.data_info.variable_info
import imp_sec_cam_nor.util.eusaar_data.distc_var as distc_var
from imp_sec_cam_nor.data_info import get_nice_name_case
...
varListNorESM = imp_sec_cam_nor.data_info.variable_info.sized_varListNorESM
...
class Sizedistribution:
    ...
    def __init__(self, case_name, from_time, to_time, dlim_sec, isSectional, time_res,
