...
from imp_sec_cam_nor.constants import path_data_info
from imp_sec_cam_nor.util.slice_average.avg_pkg import yearly_mean_dic
import pandas as pd
from imp_sec_cam_nor.data_info import get_nice_name_case, simulation_types
from imp_sec_cam_nor.util.naming_conventions.var_info import get_fancy_var_name, get_fancy_unit_xr
