...
from imp_sec_cam_nor.constants import path_eusaar_data, path_eusaar_outdata  # path_eusaar_data
from imp_sec_cam_nor.constants import project_base_path
import numpy as np
# %%
...
from imp_sec_cam_nor.util.plot.colors import get_case_col

p_histc = path_eusaar_data + '/HISTC/'
p_gen = path_eusaar_data + '/GEN/'
p_distc = path_eusaar_data + '/DISTC/'
station_table_path =project_base_path + 'imp_sec_cam_nor/imp_sec_cam_nor/misc/eusaar_table2_asmi2011.csv'
...
# %%
from imp_sec_cam_nor.constants import collocate_locations
