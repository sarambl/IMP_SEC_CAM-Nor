...
# %%
to_case = 'NFHISTnorsecpddmsbcsdyn_f19_f19_mg17'
from_cases = ['NFHISTnorsecpddmsbcsdyn_f19_f19_mg17_1p1m']
...
varl_aero2 =[
        #'SOA_NA','SOA_A1','SO4_NA','SO4_A1','SO4_A2',
         'SO4_NA', 'SO4_A1', 'SO4_A2', 'SO4_AC', 'SO4_PR', 'BC_N', 'BC_AC', 'BC_AX', 'BC_NI', 'BC_A', 'BC_AI', 'OM_NI', 'OM_AI', 'OM_AC', 'DST_A2', 'DST_A3', 'SS_A1', 'SS_A2', 'SS_A3', 'SOA_A1',  'SOA_NA',
        'cb_SO4_NA','cb_SO4_A1','cb_SO4_A2','cb_SO4_AC','cb_SO4_PR','cb_BC_N','cb_BC_AC','cb_BC_AX','cb_BC_NI','cb_BC_A','cb_BC_AI','cb_OM_NI','cb_OM_AI','cb_OM_AC','cb_DST_A2','cb_DST_A3','cb_SS_A1','cb_SS_A2','cb_SS_A3','cb_SOA_A1','cb_SOA_NA',
       ]
...
for var in varl_aero1:
    load_and_plot(var, cases1, startyear, endyear, avg_over_lev, pmin=pmin, pressure_adjust=pressure_adjust, relative=True)
    #plt.tight_layout()
    plt.show()
